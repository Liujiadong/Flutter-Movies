...
class CommentItemView extends StatelessWidget {
  ...
  Widget _headerView(BuildContext context) {
    ...
    final isDark = Provider.of<ThemeViewModel>(context, listen: false).isDark(context);
    final none = isDark ? Colors.white30: Colors.black12;
    final count = isDark ? Colors.white: Colors.black45;
